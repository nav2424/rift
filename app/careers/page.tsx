          ...
          <GlassCard variant="liquid" className="p-10 md:p-12 relative overflow-hidden group">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-3xl font-light text-white">Work at Rift</h2>
              </div>
          ...
          <GlassCard variant="liquid" className="p-10 md:p-12 relative overflow-hidden group">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-3xl font-light text-white">Open Positions</h2>
              </div>
          ...
          <GlassCard variant="liquid" className="p-10 md:p-12 relative overflow-hidden group">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-3xl font-light text-white">How to Apply</h2>
              </div>
              <p className="text-white/80 leading-relaxed font-light mb-6 text-lg">
              ...
              <a 
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-green-500/10 to-green-500/5 border border-green-500/20 text-white hover:border-green-500/40 hover:from-green-500/20 hover:to-green-500/10 transition-all font-light text-lg group/link"
              >
          ...
          <GlassCard variant="liquid" className="p-10 md:p-12 relative overflow-hidden group">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-8">
                ...
                <h2 className="text-3xl font-light text-white">What We Offer</h2>
              </div>
                ...
                {[
                  ...
                  <div key={idx} className="p-6 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all group/item">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <h3 className="text-xl font-light text-white/90">{benefit.title}</h3>
                    </div>
