      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8">
          ...
          <GlassCard variant="liquid" className="p-12">
            <h2 className="text-3xl font-light text-white mb-4">RIFT TERMS & CONDITIONS</h2>
            <p className="text-white/50 font-light text-sm mb-8">Last Updated: December 31st 2025</p>
            ...
            <div className="prose prose-invert max-w-none space-y-8">
              ...
              <div>
                <h3 className="text-xl font-light text-white mb-4 mt-8">2. Eligibility</h3>
                <p className="text-white/80 leading-relaxed font-light mb-2">You must:</p>
                <ul className="list-none text-white/80 space-y-2 mt-4 ml-0">
                  <li className="flex items-start gap-3 font-light">
                    <span className="text-white/40 mt-1">•</span>
              ...
              <div>
                <h3 className="text-xl font-light text-white mb-4 mt-8">3. Accounts</h3>
                <p className="text-white/80 leading-relaxed font-light mb-2">You are responsible for:</p>
                <ul className="list-none text-white/80 space-y-2 mt-4 ml-0">
                  <li className="flex items-start gap-3 font-light">
                    <span className="text-white/40 mt-1">•</span>
              ...
              <div>
                <h3 className="text-xl font-light text-white mb-4 mt-8">4. Payments & Financial Processing</h3>
                <h4 className="text-lg font-light text-white/90 mb-3 mt-6">4.1 Stripe Payment Processing</h4>
                <p className="text-white/80 leading-relaxed font-light mb-4">
                  All payments on Rift are processed exclusively by third-party payment processors, including Stripe.
                </p>
                <p className="text-white/80 leading-relaxed font-light mb-2">Rift does not:</p>
                <ul className="list-none text-white/80 space-y-2 mt-4 ml-0">
                  <li className="flex items-start gap-3 font-light">
                    <span className="text-white/40 mt-1">•</span>
                ...
                <p className="text-white/80 leading-relaxed font-light mt-4 mb-4">
                ...
                <h4 className="text-lg font-light text-white/90 mb-3 mt-6">4.2 Fees</h4>
                <p className="text-white/80 leading-relaxed font-light">
              ...
              <div>
                <h3 className="text-xl font-light text-white mb-4 mt-8">5. Transactions</h3>
                <p className="text-white/80 leading-relaxed font-light mb-2">
              ...
              <div>
                <h3 className="text-xl font-light text-white mb-4 mt-8">6. Communication & Proof</h3>
                <p className="text-white/80 leading-relaxed font-light mb-4">
              ...
              <div>
                <h3 className="text-xl font-light text-white mb-4 mt-8">7. Disputes</h3>
                <p className="text-white/80 leading-relaxed font-light mb-2">Disputes:</p>
                <ul className="list-none text-white/80 space-y-2 mt-4 ml-0">
                  <li className="flex items-start gap-3 font-light">
                    <span className="text-white/40 mt-1">•</span>
              ...
              <div>
                <h3 className="text-xl font-light text-white mb-4 mt-8">8. Zero-Tolerance Misuse Policy</h3>
                <p className="text-white/80 leading-relaxed font-light mb-4">
                  Rift enforces a strict zero-tolerance policy.
                </p>
                <p className="text-white/80 leading-relaxed font-light mb-2">Prohibited conduct includes, but is not limited to:</p>
                <ul className="list-none text-white/80 space-y-2 mt-4 ml-0">
                  <li className="flex items-start gap-3 font-light">
                    <span className="text-white/40 mt-1">•</span>
              ...
              <div>
                <h3 className="text-xl font-light text-white mb-4 mt-8">9. Enforcement & Penalties</h3>
                <p className="text-white/80 leading-relaxed font-light mb-2">
              ...
              <div>
                <h3 className="text-xl font-light text-white mb-4 mt-8">10. Forfeiture of Funds</h3>
                <p className="text-white/80 leading-relaxed font-light">
              ...
              <div>
                <h3 className="text-xl font-light text-white mb-4 mt-8">11. Harassment Policy</h3>
                <p className="text-white/80 leading-relaxed font-light mb-4">
              ...
              <div>
                <h3 className="text-xl font-light text-white mb-4 mt-8">12. Limitation of Liability</h3>
                <p className="text-white/80 leading-relaxed font-light mb-2">
              ...
              <div>
                <h3 className="text-xl font-light text-white mb-4 mt-8">13. Indemnification</h3>
                <p className="text-white/80 leading-relaxed font-light">
              ...
              <div>
                <h3 className="text-xl font-light text-white mb-4 mt-8">14. Governing Law</h3>
                <p className="text-white/80 leading-relaxed font-light">
          ...
          {/* Disclaimer */}
          <GlassCard variant="liquid" className="p-12">
            <h2 className="text-3xl font-light text-white mb-8">RIFT DISCLAIMER</h2>
          ...
          {/* Privacy Policy */}
          <GlassCard variant="liquid" className="p-12">
            <h2 className="text-3xl font-light text-white mb-4">RIFT PRIVACY POLICY</h2>
            <p className="text-white/50 font-light text-sm mb-8">Last Updated: December 31st 2025</p>
            
            <div className="prose prose-invert max-w-none space-y-8">
              <div>
                <h3 className="text-xl font-light text-white mb-4 mt-8">1. Information We Collect</h3>
                <h4 className="text-lg font-light text-white/90 mb-3 mt-6">Information You Provide</h4>
                <ul className="list-none text-white/80 space-y-2 mt-4 ml-0">
                  <li className="flex items-start gap-3 font-light">
                    <span className="text-white/40 mt-1">•</span>
                ...
                <h4 className="text-lg font-light text-white/90 mb-3 mt-6">Automatically Collected Information</h4>
                <ul className="list-none text-white/80 space-y-2 mt-4 ml-0">
                  <li className="flex items-start gap-3 font-light">
                    <span className="text-white/40 mt-1">•</span>
              ...
              <div>
                <h3 className="text-xl font-light text-white mb-4 mt-8">2. Payment Information</h3>
                <p className="text-white/80 leading-relaxed font-light mb-2">Rift does not collect or store:</p>
                <ul className="list-none text-white/80 space-y-2 mt-4 ml-0">
                  <li className="flex items-start gap-3 font-light">
                    <span className="text-white/40 mt-1">•</span>
              ...
              <div>
                <h3 className="text-xl font-light text-white mb-4 mt-8">3. How We Use Information</h3>
                <p className="text-white/80 leading-relaxed font-light mb-2">We use information to:</p>
                <ul className="list-none text-white/80 space-y-2 mt-4 ml-0">
                  <li className="flex items-start gap-3 font-light">
                    <span className="text-white/40 mt-1">•</span>
              ...
              <div>
                <h3 className="text-xl font-light text-white mb-4 mt-8">4. Sharing Information</h3>
                <p className="text-white/80 leading-relaxed font-light mb-2">We may share information with:</p>
                <ul className="list-none text-white/80 space-y-2 mt-4 ml-0">
                  <li className="flex items-start gap-3 font-light">
                    <span className="text-white/40 mt-1">•</span>
              ...
              <div>
                <h3 className="text-xl font-light text-white mb-4 mt-8">5. Data Retention</h3>
                <p className="text-white/80 leading-relaxed font-light mb-2">We retain data as long as necessary for:</p>
                <ul className="list-none text-white/80 space-y-2 mt-4 ml-0">
                  <li className="flex items-start gap-3 font-light">
                    <span className="text-white/40 mt-1">•</span>
              ...
              <div>
                <h3 className="text-xl font-light text-white mb-4 mt-8">6. Security</h3>
                <p className="text-white/80 leading-relaxed font-light">
              ...
              <div>
                <h3 className="text-xl font-light text-white mb-4 mt-8">7. Your Rights</h3>
              <p className="text-white/80 leading-relaxed font-light">
              ...
              <div>
                <h3 className="text-xl font-light text-white mb-4 mt-8">8. Changes to This Policy</h3>
              <p className="text-white/80 leading-relaxed font-light">
