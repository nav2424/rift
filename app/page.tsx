      ...
      <div className="min-h-screen relative overflow-hidden bg-black">
        ...
        <section className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 lg:pt-32 lg:pb-24">
          <div className={`text-center transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light text-white mb-6 tracking-tight leading-[1.1]">
              The execution layer for online deals.
            </h1>
            <p className="text-xl sm:text-2xl text-white/80 max-w-3xl mx-auto font-light mb-8 leading-relaxed">
            ...
            <p className="text-sm text-white/50 font-light">
              Built for digital goods, tickets, and milestone work.
            </p>
          </div>
        </section>
            ...
            {[
              ...
              <div key={item.step} className="text-center">
                <GlassCard className="p-6 mb-4">
                  <div className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center mx-auto mb-4 text-white/80">
                    {item.icon}
                  </div>
        ...
        <section className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
            {[
              ...
              <GlassCard key={index} className="p-8 hover:bg-white/5 transition-colors">
                <div className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center mb-6 text-white/80">
                  {item.icon}
                </div>
            ...
            {[
              ...
              <GlassCard key={index} className="p-6 hover:bg-white/5 transition-colors">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-white/80 flex-shrink-0">
                    {item.icon}
                  </div>
                  <div>
