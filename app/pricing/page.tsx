...
export default function Pricing() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-white pt-8 pb-32">
          ...
          <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
            ...
            <GlassCard className="p-8 bg-white border border-gray-200 shadow-sm">
              <div className="text-center mb-8">
                <h3 className="text-2xl font-light text-[#1d1d1f] mb-2">{buyerCard.title}</h3>
                <p className="text-[#86868b] font-light text-sm mb-6">{buyerCard.description}</p>
                <div>
                  <div className="text-3xl font-light text-[#1d1d1f] mb-1">{buyerCard.fee}</div>
                  <div className="text-sm text-[#86868b] font-light">{buyerCard.feeLabel}</div>
        </div>
              </div>
            ...
            {/* Seller Card */}
            <GlassCard className="p-8 bg-white border border-emerald-500 shadow-sm relative">
              <div className="text-center mb-8">
                <h3 className="text-2xl font-light text-[#1d1d1f] mb-2">{sellerCard.title}</h3>
                <p className="text-[#86868b] font-light text-sm mb-6">{sellerCard.description}</p>
                <div>
                  <div className="text-3xl font-light text-[#1d1d1f] mb-1">{sellerCard.fee}</div>
                  <div className="text-sm text-[#86868b] font-light">{sellerCard.feeLabel}</div>
                </div>
              </div>
              <ul className="space-y-3 mb-8">
          ...
          <GlassCard className="p-8 lg:p-12 bg-white border border-gray-200 shadow-sm">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl sm:text-4xl font-medium text-[#1d1d1f] mb-4 tracking-tight">
                Fee <span className="text-emerald-600">Calculator</span>
              </h2>
              <p className="text-[#86868b] font-light text-base max-w-xl mx-auto">
            ...
            <div className="max-w-md mx-auto mb-10">
              ...
              <div className="relative group">
                <span className="absolute left-4 top-1/2 transform -translate-y-1/2 text-[#86868b] text-lg font-light">$</span>
                <input
                  id="amount"
                  type="number"
                  min="0"
                  ...
                  className="w-full pl-10 pr-4 py-4 bg-gray-50 border border-gray-200 rounded-xl text-[#1d1d1f] text-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 transition-all font-light hover:bg-gray-100 hover:border-gray-300"
                  placeholder="1000.00"
                />
            ...
            <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
              {/* Buyer Breakdown */}
              <div className="rounded-2xl bg-gray-50 p-6 lg:p-8 border border-gray-200 hover:border-gray-300 hover:bg-gray-100 transition-all duration-300 group">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-xl font-medium text-[#1d1d1f]">Brand Pays</h3>
                </div>
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-2">
                    <span className="text-[#86868b] font-light text-sm">Deal amount</span>
                    <span className="text-[#1d1d1f] font-medium font-mono">${amount.toFixed(2)}</span>
                  </div>
                  <div className="flex justify-between items-center py-2">
                    <span className="text-[#86868b] font-light text-sm">Processing fee (3%)</span>
                    <span className="text-gray-700 font-light text-sm font-mono">+${buyerProcessingFee.toFixed(2)}</span>
                  </div>
                  <div className="border-t border-gray-200 pt-4 mt-4">
                    <div className="flex justify-between items-center">
                      <span className="text-[#1d1d1f] font-medium">Total</span>
                      <span className="text-2xl font-medium text-emerald-600 font-mono">${buyerTotal.toFixed(2)}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-2xl bg-gray-50 p-6 lg:p-8 border border-gray-200 hover:border-gray-300 hover:bg-gray-100 transition-all duration-300 group">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-xl font-medium text-[#1d1d1f]">Creator Receives</h3>
                </div>
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-2">
                    <span className="text-[#86868b] font-light text-sm">Deal amount</span>
                  ...
                  <div className="flex justify-between items-center py-2">
                    ...
                    <span className="text-gray-700 font-light text-sm font-mono text-red-500">-${sellerPlatformFee.toFixed(2)}</span>
                  </div>
                  <div className="border-t border-gray-200 pt-4 mt-4">
                    <div className="flex justify-between items-center">
                      <span className="text-[#1d1d1f] font-medium">Net payout</span>
                      <span className="text-2xl font-medium text-emerald-600 font-mono">${sellerReceives.toFixed(2)}</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-10 pt-6 border-t border-gray-200 text-center">
              <p className="text-[#86868b] font-light text-sm flex items-center justify-center gap-2">
        ...
        {/* Fee Explanation */}
        <section className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-[#f5f5f7]">
          <GlassCard className="p-8 lg:p-12 bg-white border border-gray-200 shadow-sm">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-3 mb-6">
                <div className="h-px w-12 bg-gradient-to-r from-transparent to-emerald-500/30" />
              ...
              <h2 className="text-3xl sm:text-4xl font-medium text-[#1d1d1f] mb-6 tracking-tight">
                Understanding <span className="text-emerald-600">fees</span>
              </h2>
            </div>
            <div className="space-y-8">
              <div className="rounded-xl bg-gray-50 p-6 border border-gray-200 hover:border-gray-300 transition-all">
                <div className="flex items-start gap-4 mb-3">
                  ...
                  <div className="flex-1">
                    <h3 className="text-[#1d1d1f] font-medium text-lg mb-2">Payment processing fee (3% - paid by brand)</h3>
              ...
              <div className="rounded-xl bg-gray-50 p-6 border border-gray-200 hover:border-gray-300 transition-all">
                <div className="flex items-start gap-4 mb-3">
                  ...
                  <div className="flex-1">
                    <h3 className="text-[#1d1d1f] font-medium text-lg mb-2">Platform fee (5% - paid by creator)</h3>
                    <p className="text-[#86868b] font-light text-sm leading-relaxed">
              ...
              <div className="pt-6 border-t border-gray-200 rounded-xl bg-gray-50 p-6">
                <p className="text-gray-700 font-light text-base text-center">
                  <strong className="text-[#1d1d1f] font-medium">No monthly fees.</strong> No setup costs. No hidden charges. 
        ...
        <section className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-medium text-[#1d1d1f] mb-6 tracking-tight">
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => {
              ...
              return (
                <GlassCard key={index} className="bg-white border border-gray-200 shadow-sm overflow-hidden transition-all">
                  <button
                    onClick={() => setOpenFaqIndex(isOpen ? null : index)}
                    className="w-full p-6 lg:p-8 text-left hover:bg-gray-50 transition-all flex items-start justify-between gap-4"
                  >
                    <h3 className="text-lg font-medium text-[#1d1d1f] flex-1 transition-colors group-hover:text-emerald-600">
                      {faq.question}
                    </h3>
                    <div className={`flex-shrink-0 w-6 h-6 rounded-lg bg-gray-50 border border-gray-200 flex items-center justify-center text-[#86868b] transition-all duration-300 ${isOpen ? 'rotate-180' : ''}`}>
        ...
        {/* Final CTA */}
        <section className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24 bg-[#f5f5f7]">
          <div className="text-center">
            <div className="inline-flex items-center gap-3 mb-6">
