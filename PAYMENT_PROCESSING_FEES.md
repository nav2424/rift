...
- Covers platform services, protection, and dispute resolution
...
- Example: Buyer pays $103 (subtotal $100 + 3% fee) → Platform receives ~$99.91
...
- **Transparent pricing**: Both buyers and sellers see fees upfront
- **Simple UX**: Fixed fee structure eliminates decision friction
- **Healthy margins**: 5% platform fee covers costs and profit
- **Scalable**: Standard fee structure across all transaction types
- **Clear value**: Sellers understand exactly what they receive
