...
export default function FeeBreakdown({
  ...
  return (
    <GlassCard className="p-6">
      <h3 className="text-lg font-light text-white mb-6">Fee Breakdown</h3>
        ...
        {showBuyer && (
          <div className="pb-6 border-b border-white/10">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h4 className="text-base font-light text-white">Buyer Pays</h4>
            </div>
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <span className="text-white/70 font-light text-sm">Listed Price</span>
                <span className="text-white font-light">{formatCurrency(subtotal)}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-white/60 font-light text-sm">Processing Fee (3%)</span>
                <span className="text-white/70 font-light">+{formatCurrency(buyerFee)}</span>
              </div>
        ...
        {showSeller && (
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h4 className="text-base font-light text-white">Seller Receives</h4>
            </div>
            <div className="space-y-2">
              <div className="flex justify-between items-center">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-white/70 font-light">-{formatCurrency(sellerFee)}</span>
              </div>
              <div className="flex justify-between items-center pt-2 border-t border-white/10">
                <span className="text-white font-light">Net Amount</span>
